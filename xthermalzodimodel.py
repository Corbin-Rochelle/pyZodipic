...
'''
def xthermalzodimodel(lstar, tstar, num, inu, stepau, inc, lambda, radin, radout, Qabsuser, emit, lambdaQabs, iras=iras, useralpha=useralpha, userdelta=userdelta, scube=scube, userdustsize=userdustsize):
