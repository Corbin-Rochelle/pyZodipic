...
def xscatteringzodimodel(lstar, tstar, rstar, num, inu, stepau, inc, pos, lambda, radin, radout, pfunc500, Qabsuser, emit, lambdaQabs, albedo=albedo, iras=iras, scatterflag=scatterflag, useralpha=useralpha, userdelta=userdelta, scube=scube, userdustsize=userdustsize):
